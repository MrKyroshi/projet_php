...
// n"cessaire au fonctionnement d'un formulaire:
// attribut action sur la balise form inutile à rensigné si le traitement à lieu dans la même page
// attribut method="post" toujours sur la balise form pour remplir la superglobal $_POST sinon par défaut le formulaire transiterai en méthode get et remplirai donc la superglobale $_GET
// si le formulaire contient un input type file, l'attribut enctype="multipart/form-data" afin de remplir la suêrglobale $_FILES
